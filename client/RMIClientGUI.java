...
public class RMIClientGUI extends Application {
    ...
    private void showMain(Stage stage) {
        try {
            ...
            CustomModal.show(primaryStage, "Gabim", "Nuk mund të lidhet me serverin RMI:\n" + e.getMessage());
        ...
        headerTitle = new Label(" RMI Libraria Online");
    ...
    private void updateCardsFromResponse(String response) {
        ...
        for (String line : lines) {
            ...
            foundBook = true;
            // ...kodi ekzistues për krijimin e kartelave...
            ...
            actionBtn.setOnAction(e -> {
                if (actionBtn.getText().equals("📚 Huazo")) {
                    try {
                        String resp = libraryService.borrowBook(id);
                    ...
                    try {
                        String resp = libraryService.returnBook(id);
    ...
    private void searchBook() {
        ...
        if (keyword.isEmpty()) {
            CustomModal.show(primaryStage, "Kujdes", "Shkruajni një fjalë kyçe për kërkimin.");
            return;
        }
        try {
            String response = libraryService.searchBooks(keyword);
